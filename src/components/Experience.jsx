...
const Experience = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#2e2e2e] p-6 rounded-lg shadow-2xl transform transition-transform duration-500 ease-out space-y-4 md:space-y-0 max-w-md max-h-[80vh] overflow-y-auto">
          <button
